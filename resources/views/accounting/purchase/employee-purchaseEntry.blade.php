        ...
        <div class="row staticRow dynamicRow0" style="margin-top: 1%;">
          ...
          <div class="col-sm-3">
           <div class="form-group">
              ...
              <input type="text" id="Account0" name="account0" class="inputHolder form-control resp0">
...
<script type="text/javascript" src="{{asset('js/employeeAccountingPurchase.js')}}"></script>
