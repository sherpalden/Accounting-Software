      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary" id="SearchHeader">
            <h4 class="card-title">Bills Receivable</h4>
          </div>
...
<!-- *****Purchase Entry Form OR Page Starts***** -->
  ...
  <div class="row" style="border: 0px solid black;">
    ...
    <div class="col-sm-2 text-center" style="border-right: 2px solid black;">
      <div class="form-group">
         <label class="font-weight-bold">Received Amt.</label>
      </div>
    </div>
...
<script type="text/javascript" src="{{asset('js/employeeAccountingBillsReceivable.js')}}"></script>
