      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary" id="SearchHeader">
            <h4 class="card-title">Payment Entry</h4>
          </div>
  ...
  <div class="row">
   <div class="col-md-3">
      <div class="form-group">
        ...
        <input type="text" id="nepaliDate2" class="nepali-calendar form-control" placeholder="Date" />
      </div>
    </div>
    ...
    <div class="col-md-5">
      <div class="form-group">
        ...
        <select id="VendorSelect" class="form-control">
          <option>Indian Company (PAN No. 78495315)</option>
          <option>Chinese Company (PAN No. 78495315)</option>
        </select>
      </div>
    </div>
    <div class="col-sm-4">
...
<script type="text/javascript" src="{{asset('js/employeeAccountingPayment.js')}}"></script>
