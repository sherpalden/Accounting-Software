...
$(document).on('submit', '#PurchaseVat', function(e) {
   ...
   var PurchaseEntryData = { 
    ...
    $.ajax({
        url: '/employee/accounting/add/PurchaseEntry',
        method: 'POST',
...
$(document).on('click', '#Account0', function(e) {
   e.preventDefault();
    $.ajaxSetup({
        ...
        $.ajax({
            url: '/employee/accounting/get/CategoryData',
            method: 'GET',
            beforeSend: function() {
                $('#modalLoading').html('<div class="spinner-grow text-muted"></div>\
                        <div class="spinner-grow text-primary"></div>\
...
//     $.ajax({
//         url: '/employee/vat/PurchaseSales/category/'+purchaseType,
//         method: 'GET',
//         beforeSend: function() {
//             $('#modalLoading').html('<div class="spinner-grow text-muted"></div>\
//                     <div class="spinner-grow text-primary"></div>\
...
//     });
//     $.ajax({
//         url: '/employee/add/vat/PurchaseSalesCategory',
//         method: 'POST',
